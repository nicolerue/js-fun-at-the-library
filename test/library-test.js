...
describe("library.js", function () {
  ...
  describe("takeStock", function () {
    it("should be able to take stock of how many books are on a shelf", function () {
      ...
      assert.equal(
        takeStock(auroraLibrary, "fantasy"),
        "There are a total of 2 fantasy books at the Aurora Public Library."
      );
    });
    ...
    it("should be able to count the number of books on a different shelf", function () {
      ...
      assert.equal(
        takeStock(laLibrary, "nonFiction"),
        "There are a total of 1 nonFiction books at the Los Angeles Public Library."
      );
    });
